...
//        }
    ...
    public void requestWeather(final String weatherId) {
        ...
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId + "&key=7f75d82608ee4619a97fbb7352bbff12";
        HttpUtil.sendOkHttpRequest(weatherUrl, new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(WeatherActitvity.this, "获取天气信息失败", Toast.LENGTH_SHORT).show();
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (weather != null && "ok".equals(weather.status)) {
                            ...
                            SharedPreferences.Editor editor = PreferenceManager.getDefaultSharedPreferences(WeatherActitvity.this).edit();
        ...
        HttpUtil.sendOkHttpRequest(requestBingPic, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Glide.with(WeatherActitvity.this).load(bingPic).into(bingPicImg);
                    }
                });
